...
void main()
{
	...
	serverHint.sin_port = htons(27277); // Convert from little to big endian
	...
	client.sin_port = htons(27277); // Little to big endian conversion
	...
	while (true)
	{
		...
		// Send back message
		/*string message = "I'm fine, thank you!";

		int sendOk = sendto(in, message.c_str(), message.size() + 1, 0, (sockaddr*)&client, sizeof(client));
